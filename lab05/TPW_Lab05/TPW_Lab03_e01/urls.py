...
urlpatterns = [
    ...
    #path('bookquery/', views.bookquery, name="book query form"),
    path('authorquery/', views.authorquery, name="author query form"),
    path('insertbook/', views.insertbook, name="insert book form"),
    #path('insertauthor/', views.insertauthor, name="insert author form"),
    path('insertpublisher/', views.insertpublisher, name="insert publisher form"),
    ####### AULA 05
    path('login/', auth_views.LoginView.as_view(template_name='login.html'), name='login'),
    path('logout/', auth_views.LogoutView.as_view(next_page='/'), name='logout'),
    path('insertauthor/', views.authorins, name="insert author form"),
    path('bookquery/', views.bookquery_session, name="book query form"),
]
